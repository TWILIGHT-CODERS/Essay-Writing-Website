        ...
        <div class="col-md-8">
          <div class="card-group">
            <div class="card p-4">
              <div class="card-body">
                <h1>Login</h1>
                <p class="text-muted">Login to your Elites Paper account</p>
                <form method="POST" action="{{ route('login') }}">
                    @csrf
                     <div class="form-group">
                        <label class="form-col-form-label" for="email">Email</label>
                        <input name="email" class="form-control @error('email') is-invalid @enderror" id="email" type="text" placeholder="{{ __('E-Mail Address') }}" autofocus="autofocus" value="{{ old('email') }}">
                        @error('email')
                    ...
                    <div class="row">
                    <div class="col-6">
                        <button class="btn btn-purple px-4" type="submit">{{ __('Login') }}</button>
                    </div>
                    </form>
